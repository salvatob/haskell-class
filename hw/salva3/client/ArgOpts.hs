...
getWindow opts = pure ( windowWidth opts, windowHeight opts, windowX opts, windowY opts)
...
cfg = Config
  ...
  <*> option auto ( long "windowX" <> short 'x' <> metavar "Int" <> value 350 
      <> help "The x position of the tol-left corner of the canvas window.")
  <*> option auto ( long "windowY" <> short 'y' <> metavar "Int" <> value 150
      <> help "The y position of the tol-left corner of the canvas window.")
